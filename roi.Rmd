...
So the 26 people who responded spend around $800,000 of the agency's money annually just looking around for, identifying and getting data. 
...
The assumptions taken above represent a high-level attempt to concentualize the poll results using basic assumptions. Some of those assumptions may change following a bit more thought, but this discussion aims to offer value as a starting point regarding the potential value — to the agency — of rationalizing data management and governance. 